    ...
    <ScrollView>
      <Card style={styles.container}>
        <View style={styles.subContainer}>
          ...
          <View>
            <Text style={{fontSize: 16}}> Name: {this.state.product.prodName}</Text>
          </View>
          <View>
            <Text style={{fontSize: 16}}>Organization : {this.state.product.prodDesc}</Text>
          </View>
          <View>
            <Text style={{fontSize: 16}}> Status: {this.state.product.prodPrice}</Text>
          </View>
        </View>
