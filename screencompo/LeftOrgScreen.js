...
import { StyleSheet, FlatList, ActivityIndicator, View, Alert, Text, TouchableOpacity} from 'react-native';
...
export default class LeftOrgScreen extends Component {
...
//Add a constructor function.
  constructor() {
    ...
    this.state = {
      isLoading: true,
      products: [],
      notFound: 'User of Left Organization not found.\nPlease click (+) button to add it.'
    };
  }
